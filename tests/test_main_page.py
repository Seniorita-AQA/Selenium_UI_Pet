...
def test_go_to_login_page(driver):
    ...
    time.sleep(5)
    driver.save_screenshot('result_log_page.png')


@pytest.mark.regression
def test_filter_by_type(driver):
    link = 'http://34.141.58.52:8080/#/'
    page = MainPage(driver, link)
    page.open()
...
@pytest.mark.regression
def test_filter_by_pet_name(driver):
    link = 'http://34.141.58.52:8080/#/'
    page = MainPage(driver, link)
    page.open()
...
@pytest.mark.regression
def test_show_pet_details(driver):
    link = 'http://34.141.58.52:8080/#/'
    page = MainPage(driver, link)
    page.open()
...
@pytest.mark.regression
def test_like_pet_card(driver, auth_user):
    link = 'http://34.141.58.52:8080/#/'
    page = MainPage(driver, link)
    page.open()
    page.like_pet_card()
...
@pytest.mark.regression
def test_add_comment(driver, auth_user):
    link = 'http://34.141.58.52:8080/#/'
    page = MainPage(driver, link)
    page.open()
    page.like_pet_card()
